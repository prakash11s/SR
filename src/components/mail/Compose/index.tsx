...
import { IComposeMailProps, IComposeMailState } from './Interface/IndexInterface';

class ComposeMail extends React.Component<IComposeMailProps, IComposeMailState> {
  constructor(props: IComposeMailProps) {
    super(props);
    this.state = {
      to: '',
      cc: '',
