      ...
      data.additional_data.map((data) => {
        return (
          <>
            ...
            <IntlMessages id="brand" /> : {data.json_value.brand.name} <br />
            <IntlMessages id="model" /> : {data.json_value.model.name}
            <br />
            <IntlMessages id="fuel" /> : {data.json_value.fuel.name}
            <br />
            <IntlMessages id="vehicleStepperStep1.constructionYear" /> :{" "}
            {moment(data.json_value.construction_year).format("DD-MM-YYYY")}
          </>
        );
      })
    );
