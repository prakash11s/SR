...
import { IAppModuleHeaderProps, IAppModuleHeaderState, IAppModuleDefaultProps } from './Interface/IndexInterface';

class AppModuleHeader extends React.Component<IAppModuleHeaderProps, IAppModuleHeaderState> {
  ...
  constructor(props: IAppModuleHeaderProps) {
    super(props);
    this.state = {
      anchorEl: undefined,
      searchBox: false,
...
(AppModuleHeader as IAppModuleDefaultProps).defaultProps = {
  styleName: '',
  value: '',
  notification: true,
  apps: true
