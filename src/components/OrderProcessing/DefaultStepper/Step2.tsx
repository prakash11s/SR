...
import {
  ...
  IStep3Props,
  IRootStep3State1,
} from "./../VehiclesStepper/Interface/Step3Interface";
import { useIntl } from "react-intl";
import { IService } from "./../VehiclesStepper/Interface/Step4Interface";
import axios from "../../../util/Api";
import Autocomplete from "@material-ui/lab/Autocomplete/Autocomplete";

const DefaultStep2 = (props: IStep3Props) => {
  ...
  useEffect(() => {
    if (
      ...
      if (supportCodeData.salutation) {
        setTitle(supportCodeData.salutation.toLowerCase() == "mr" ? "mr." : "mrs.");
      }
    ...
    if (
      ...
      setTitle(orderPrefillData.salutation && orderPrefillData.salutation);
          ...
          <CardBody className="row">
            ...
            <div className="col-6">
              ...
              <DataAssignment
                ...
                base64Data={preparePaymentPayload()}
