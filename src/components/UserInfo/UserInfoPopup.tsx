...
import { IUserInfoPopupProps, IUserInfoPopupState } from './Interface/UserInfoPopupInterface';

class UserInfoPopup extends React.Component<IUserInfoPopupProps, IUserInfoPopupState> {
  render() {
    return (
      <div>
