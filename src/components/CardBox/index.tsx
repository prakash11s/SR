...
import { ICardBoxProps } from './Interface/IndexInterface'

const CardBox = ({heading, children, styleName, cardStyle, childrenStyle, headerOutside,headingStyle}: ICardBoxProps) => {
  return (
    <div className={`${styleName}`}>
      {headerOutside &&
      <div className={heading ? "jr-entry-header" : ""}>
