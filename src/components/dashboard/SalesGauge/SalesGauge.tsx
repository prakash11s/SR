...
const SalesGauge: React.FC<any> = props => {

    useEffect(() => {
        let chart: any = am4core.create("chartdiv", am4charts.RadarChart);
...
// Create axes
        ...
        let valueAxis: any = chart.xAxes.push(new am4charts.ValueAxis());
...
// Create series
        let series1: any = chart.series.push(new am4charts.RadarColumnSeries());
        ...
        let series2: any = chart.series.push(new am4charts.RadarColumnSeries());
