...
class Menu extends Component<any,any> {
  ...
  componentDidMount() {
    ...
    const mainMenu:any = document.getElementsByClassName('nav-item');
    ...
    const subMenuLi:any = document.getElementsByClassName('nav-arrow');
  ...
  closest(el:any, selector: string) {
    try {
      let matchesFn:any;
      // find vendor prefix
